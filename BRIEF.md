...
- [X] 8. Make adjustments based on the evaluation of the reports quality. Iterate this until it's high quality.
- [X] 9. Deploy the MVP version to production and do a full end-to-end test there. _(live: https://<app>.fly.dev)_
- [X] 10. Work on delight features, look at the report screenshots and make sure the layouts are readable and the design spec is reflected on the MVP `DESIGN.md`.
...
- [X] 14. Fully conversational experience — with voice mode on, the agent speaks and listens end-to-end (ElevenLabs TTS + Scribe STT), making the interview hands-free. _(hands-free: auto-listen + silence detection)_
